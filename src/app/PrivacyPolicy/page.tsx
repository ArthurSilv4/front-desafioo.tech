      ...
      <div className="container m-auto p-4 bg-white rounded-lg shadow-lg">
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            A sua privacidade é importante para nós. É política do desafioo.tech
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site <a href="desafioo.tech">desafioo.tech</a>,
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            ...
            informação que o desafioo.tech oferece no site e com caráter
        ...
        <ul>
          ...
          <li>
            <span style={{ color: "rgb(68, 68, 68)" }}>
              ...
              (softwares) do desafioo.tech, de seus fornecedores ou terceiros,
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            Esta política é efetiva a partir de&nbsp;9 February 2025 04:07
          </span>
        </p>
      </div>
    </main>
